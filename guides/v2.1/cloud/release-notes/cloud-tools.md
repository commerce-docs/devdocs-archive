...
-   {:.new}**Docker Updates**—
    ...
    -   {:.new}<!-- MAGECLOUD-3569 -->There are new quick commands available to improve the Docker command line experience. See the [`bin/docker` section of the Docker reference]({{page.baseurl}}/cloud/docker/docker-quick-reference.html#bindocker). All Docker configuration files moved to the `.docker` directory.
