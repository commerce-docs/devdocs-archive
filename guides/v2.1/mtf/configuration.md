...
| `log_directory` | Path to a directory with testing reports. | `"<path to the reporting directory>"` | [Set a reporting directory](https://devdocs.magento.com/guides/v2.0/mtf/features/reporting.html#report-directory){: target="_blank"} |
