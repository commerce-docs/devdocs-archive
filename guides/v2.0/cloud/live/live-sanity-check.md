...
* `config.local.php` if you used [Configuration Management](https://devdocs.magento.com/guides/v2.1/cloud/live/sens-data-over.html) for 2.1.X
* `config.php` if you used [Configuration Management](https://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-over.html) for 2.2.X
...
The build also checks for a [configuration file](https://devdocs.magento.com/guides/v2.1/cloud/live/sens-data-over.html). If the file exists, the static file deployment is also completed during the build stage. If not, it's completed in the deployment stage.
