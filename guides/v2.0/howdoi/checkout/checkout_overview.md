...
Magento {% glossarytooltip 278c3ce0-cd4c-4ffc-a098-695d94d73bde %}checkout{% endglossarytooltip %} is implemented using the [UI components](https://devdocs.magento.com/guides/v2.1/ui_comp_guide/bk-ui_comps.html).
