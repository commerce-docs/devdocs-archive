...
Review the [Magento technology stack requirements](https://devdocs.magento.com/guides/v2.3/install-gde/system-requirements-tech.html) before upgrading your Magento application.
