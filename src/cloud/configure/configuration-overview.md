...
*  Install Magento security extensions including [Google reCAPTCHA](https://devdocs.magento.com/guides/v2.3/security/google-recaptcha.html) and [Two-Factor Authentication](https://devdocs.magento.com/guides/v2.3/security/two-factor-authentication.html) to enhance secure access to the Magento Admin UI and storefront
