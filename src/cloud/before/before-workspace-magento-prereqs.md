...
We strongly recommend installing [Nginx](https://devdocs.magento.com/guides/v2.3/install-gde/prereq/nginx.html) for your web server on your local. While {{site.data.var.ee}} supports [Apache](https://devdocs.magento.com/guides/v2.3/install-gde/prereq/apache.html), {{site.data.var.ece}} uses Nginx. To have your local as close to cloud installations as possible, install and configure Nginx.

## PHP (local) {#php}

Install [PHP](https://glossary.magento.com/php) on your local workstation. For information on installing PHP, see [PHP Settings](https://devdocs.magento.com/guides/v2.3/install-gde/prereq/php-settings.html). For instructions for another OS, see the [PHP documentation](http://php.net/manual/en/install.php).
...
*  [{{site.data.var.ee}} requirements](https://devdocs.magento.com/guides/v2.3/install-gde/system-requirements.html)
*  [(Integrator) Integrator installation](https://devdocs.magento.com/guides/v2.3/install-gde/composer.html)

## Additional options

You can also install additional [optional software](https://devdocs.magento.com/guides/v2.3/install-gde/prereq/optional.html). These packages should be installed on the local VM.
