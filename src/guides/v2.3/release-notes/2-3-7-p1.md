...
For instructions on downloading and applying security patches (including patch 2.4.2-p1), see [Quick start install](https://devdocs.magento.com/guides/v2.4/install-gde/composer.html).
